...
namespace core.Migrations
{
    ...
    [Migration("20240410204324_CommentBelongsToUser")]
    partial class CommentBelongsToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "37bc4f3d-b6d6-41cd-ba76-41ff7151c9a2",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "4fb40090-cf09-48ab-ab66-552d6e74c742",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("core.Models.Portfolio", b =>
                {
                    ...
                    b.HasIndex("StockId")
                        .HasDatabaseName("ix_portfolios_stock_id");
            ...
            modelBuilder.Entity("core.Models.Portfolio", b =>
                {
                    b.HasOne("core.Models.Stock", "Stock")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_portfolios_stocks_stock_id");
